                ...
                accountMineClass -> {
                    ...
                    if (platform == "android_hd") {
                        ...
                        result.getObjectFieldOrNullAs<MutableList<*>?>("sectionListV2")?.removeAll { sections ->
                            ...
                            if (title !in hides) {
                                if (title == "创作中心" || title == "游戏中心" || title == "创作中心" || title == "游戏中心")
                                    deleteTitle = false // 标记
                                else if (title == "推荐服务" || title == "推荐服务")
                                    deleteTitle = true // 取消标记
                            } else {
                                if ((title == "更多服务" || title == "更多服务") && !deleteTitle) {
